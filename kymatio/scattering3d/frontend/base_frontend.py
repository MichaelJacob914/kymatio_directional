...
class ScatteringBase3D(ScatteringBase):
    def __init__(self, J, shape, L=3, sigma_0=1, max_order=2,
                 ...
                 integral_powers=(0.5, 1., 2.), backend=None, original = True, wavelet_choice = 'origin'):
    ...
    def create_filters(self, original = True, wavelet_choice = 'origin'):
        self.filters = solid_harmonic_filter_bank(
            self.M, self.N, self.O, self.J, self.L, self.sigma_0, original = original, wavelet_choice = wavelet_choice)
